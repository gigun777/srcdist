...
export async function runImportPipelineDryRunV2(input, { mode = 'replace', inspectLimit = 200 } = {}) {
  ...
  // 1) Basic ZIP/manifest validation (existing dry-run)
  ...
  // 2) Read key JSON files (templates/settings/navigation)
  ...
  // 3) Inspect journals: template presence, columns mismatch, basic row stats, path conflicts
